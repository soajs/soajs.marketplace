...
module.exports = (grunt) => {
	...
	grunt.initConfig({
		...
		jshint: {
			...
			files: {
				src: ['index.js', '_index.js', 'config.js', 'Gruntfile.js', 'bl/**/*.js', 'driver/**/*.js', 'lib/*.js', 'bl/lib/*.js', 'model/mongo/*.js', 'utils/*.js', 'test/helper.js', 'test/unit/**/*.js', 'test/integration/**/*.js']
			},
			gruntfile: {
				src: 'Gruntfile.js'
			}
