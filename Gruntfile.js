...
module.exports = (grunt) => {
	...
	grunt.initConfig({
		...
		jshint: {
			...
			files: {
				src: ['index.js', 'config.js', 'Gruntfile.js', 'schema/*.js', 'utils/*.js', 'driver/**/*.js',  'bl/*.js', 'model/mongo/*.js', 'test/helper.js', 'test/unit/**/*.js', 'test/integration/**/*.js']
			},
			gruntfile: {
				src: 'Gruntfile.js'
			}
		...
		instrument: {
			src: ['index.js', 'config.js', 'schema/*.js', 'bl/*.js', 'utils/*.js', 'driver/**/*.js', 'model/mongo/*.js'],
			options: {
				lazy: false,
